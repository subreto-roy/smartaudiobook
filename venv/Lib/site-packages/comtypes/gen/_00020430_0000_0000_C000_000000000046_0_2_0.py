...
IFontDisp = Font
__all__ = [ 'Gray', 'OLE_CANCELBOOL', 'OLE_XPOS_PIXELS',
           'OLE_ENABLEDEFAULTBOOL', 'FONTSIZE', 'OLE_YPOS_HIMETRIC',
           'IFontEventsDisp', 'IFontDisp', 'OLE_XSIZE_CONTAINER',
           'FONTBOLD', 'IPicture', 'OLE_HANDLE', 'OLE_YPOS_CONTAINER',
           'OLE_TRISTATE', 'Unchecked', 'OLE_XSIZE_PIXELS',
           'StdPicture', 'FONTUNDERSCORE', 'OLE_XPOS_CONTAINER',
           'IFont', 'FONTNAME', 'VgaColor', 'Color',
           'OLE_YSIZE_PIXELS', 'FONTSTRIKETHROUGH', 'IPictureDisp',
           'OLE_COLOR', 'OLE_YSIZE_HIMETRIC', 'Monochrome',
           'OLE_XSIZE_HIMETRIC', 'Checked', 'Picture',
           'OLE_XPOS_HIMETRIC', 'Default', 'FONTITALIC', 'StdFont',
           'FontEvents', 'LoadPictureConstants', 'OLE_YPOS_PIXELS',
           'OLE_YSIZE_CONTAINER', 'Font', 'OLE_OPTEXCLUSIVE']
